...
def sendemail(request):
    if request.method=="POST":
        ...
        #requester
        send_mail(to_sender_subject,to_sender,settings.EMAIL_HOST_USER,[email],fail_silently=False,)
        
        #myself
        to_me="Hello Himanshu,\n"+"you got contacted by "+person_name+" \n"+"Message for you is, "+message
        send_mail(email_subject,to_me,settings.EMAIL_HOST_USER,['hbp53@njit.edu'],fail_silently=False,)
